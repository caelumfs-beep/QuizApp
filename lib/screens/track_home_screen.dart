...
class TrackHomeScreen extends StatelessWidget {
  ...
  String _trackLabel(QuizTrack track) {
    switch (track) {
      case QuizTrack.trad: return 'TRAD Reviewer';
      case QuizTrack.vulSetA: return 'VUL — Set A';
      case QuizTrack.vulSetB: return 'VUL — Set B';
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final unlocked = provider.unlockedLevels;
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Level ${unlocked > totalLvls ? totalLvls : unlocked} unlocked',
                            style: GoogleFonts.nunito(
                              fontSize: 13,
              ...
              _MenuCard(
                ...
                subtitle: 'Go through all ${provider.allQuestionsForTrack.length} questions',
